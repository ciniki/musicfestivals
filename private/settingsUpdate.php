...
function ciniki_musicfestivals_settingsUpdate(&$ciniki, $tnid, $festival_id, $args) {
    ...
    $valid_settings = array(
        ...
        'classlabels-avery-template',
        'classlabels-class-section',
        'classlabels-class-category',
        ...
        'registration-scheduling-requests', 
        ...
        'provincials-email-register-live-subject',
        ...
        'competitor-individual-phone-work',
        'competitor-individual-phone-work-label',
        ...
        'competitor-individual-school',
        'competitor-individual-school-label',
        ...
        'competitor-group-school',
        'competitor-group-school-label',
...
//        'locations-disciplines',
        ...
        'dailyvenuecompetitors-warmup-times',
        ...
        'volunteers-signup-review',         // Review volunteer signups, require approval
        ...
        'volunteers-email-shift-changed-subject',
        'volunteers-email-shift-changed-message',
        'volunteers-email-shift-cancelled-subject',
        'volunteers-email-shift-cancelled-message',
