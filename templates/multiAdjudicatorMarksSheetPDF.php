                ...
                foreach($timeslot['adjudicators'] as $adjudicator) {
                    ...
                    foreach($adjudicator['registrations'] as $reg) {
                        ...
                        for($i = 1; $i <= 8; $i++) {
                            ...
                            $reg["fulltitle{$i}_h"] = $pdf->getStringHeight($wncm[1], $reg["fulltitle{$i}"]);
                            $h += $reg["fulltitle{$i}_h"];
                        }
                        ...
                        for($i = 1; $i <= 8; $i++) {
                            ...
                            $pdf->MultiCell($wncm[1], $reg["fulltitle{$i}_h"], $reg["fulltitle{$i}"], 1, 'L', 0, 0);
                            $pdf->MultiCell($wncm[2], $reg["fulltitle{$i}_h"], '', 1, 'L', 0, 1);
                        }
                    }
