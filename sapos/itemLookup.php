...
function ciniki_musicfestivals_sapos_itemLookup($ciniki, $tnid, $args) {
    ...
    if( !isset($args['object']) || $args['object'] == '' 
        ...
        return array('stat'=>'fail', 'err'=>array('code'=>'ciniki.musicfestivals.386', 'msg'=>'No item specified'));
    }
    ...
    if( !isset($args['customer_id']) || $args['customer_id'] == 0 ) {
        return array('stat'=>'warn', 'err'=>array('code'=>'ciniki.musicfestivals.387', 'msg'=>'You must add a customer first'));
    }
    ...
    // Lookup the class 
    //
    if( $args['object'] == 'ciniki.musicfestivals.class' ) {
        //
        ...
        if( $rc['stat'] != 'ok' ) {
            return array('stat'=>'fail', 'err'=>array('code'=>'ciniki.musicfestivals.426', 'msg'=>'', 'err'=>$rc['err']));
        }
