...
//            . "var e=C.gE('f-competitor'+c+'_edit');"
            . "if(t==-1){"
                ...
                . "f.action='{$request['ssl_domain_base_url']}/account/musicfestival/competitors?add=individual';"
                . "f.submit();"
            . "} "
            . "else if(t==-2){"
                . "C.gE('f-action').value='addcompetitor';"
                . "var f=C.gE('addregform');"
                . "f.action='{$request['ssl_domain_base_url']}/account/musicfestival/competitors?add=group';"
                . "f.submit();"
            . "}"
        . "};"
        . "function competitorEdit(c){"
            ...
            . "if(t>0){"
                ...
                . "f.appendChild(i);"
                . "f.action='{$request['ssl_domain_base_url']}/account/musicfestival/competitors';"
                . "f.submit();"
            . "}"
        . "};"
        . "function formCancel(){"
