...
/*                    if( !isset($sections[$sid]['classes'][$cid]['live_fee'])
    ...
    for($i = 1; $i <= 3; $i++ ) {
        $class = ($i > 1 ? 'hidden' : '');
        if( isset($selected_class) && $i == 2 && (($selected_class['flags']&0x1000) == 0x1000 || ($selected_class['flags']&0x2000) == 0x2000) ) {
            $class = '';
        }
        elseif( isset($selected_class) && $i == 3 && (($selected_class['flags']&0x2000) == 0x2000) ) {
            $class = '';
        }
...
//            . "console.log('test');"
        ...
        . "function competitorSelected(c) {"
            ...
            . "if(t==-1){"
                . "console.log('open add competitor');"
    ...
    return array('stat'=>'ok', 'fields'=>$fields, 'js'=>$js, 'selected_section'=>$selected_section, 'selected_class'=>$selected_class, 'sections'=>$sections);
}
?>
