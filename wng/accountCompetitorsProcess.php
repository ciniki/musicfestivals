...
function ciniki_musicfestivals_wng_accountCompetitorsProcess(&$ciniki, $tnid, &$request, $args) {
    ...
    if( $rc['stat'] != 'ok' ) {
        return array('stat'=>'fail', 'err'=>array('code'=>'ciniki.musicfestivals.351', 'msg'=>'Unable to load festival', 'err'=>$rc['err']));
    }
            ...
            if( $customer_type == 10 ) {
                $blocks[] = array(
                    ...
                    'columns' => array(
                        ...
                        array('label' => 'Instrument', 'field' => 'instrument', 'class' => 'alignleft'),
