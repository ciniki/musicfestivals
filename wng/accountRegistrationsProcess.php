    ...
    elseif( isset($_POST['f-registration_id']) && isset($_POST['f-action']) && $_POST['f-action'] == 'update' && count($errors) == 0 ) {
        ...
        foreach($fields as $field) {
            if( $field['ftype'] == 'line'
                ...
                || (($selected_class['flags']&0x2000) == 0 && $field['id'] == 'title3')
                || (($selected_class['flags']&0x2000) == 0 && $field['id'] == 'perf_time3')
    ...
    //
        ...
        $rc = ciniki_core_dbHashQueryArrayTree($ciniki, $strsql, 'ciniki.musicfestivals', array(
            array('container'=>'registrations', 'fname'=>'id', 
                'fields'=>array('id', 'status', 'invoice_id', 'display_name', 'class_code', 'class_name', 'codename', 'fee', 'title1'),
                ),
            ));
        if( $rc['stat'] != 'ok' ) {
