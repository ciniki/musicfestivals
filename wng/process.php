...
function ciniki_musicfestivals_wng_process(&$ciniki, $tnid, &$request, $section) {
    ...
    if( $section['ref'] == 'ciniki.musicfestivals.syllabus' ) {
    ...
    } elseif( $section['ref'] == 'ciniki.musicfestivals.syllabuspdfs' ) {
        $section['settings']['pdfbuttons-only'] = 'yes';
        ciniki_core_loadMethod($ciniki, 'ciniki', 'musicfestivals', 'wng', 'syllabusProcess');
        return ciniki_musicfestivals_wng_syllabusProcess($ciniki, $tnid, $request, $section);
    ...
    } elseif( $section['ref'] == 'ciniki.musicfestivals.syllabusresults' ) {
        ciniki_core_loadMethod($ciniki, 'ciniki', 'musicfestivals', 'wng', 'syllabusResultsProcess');
        return ciniki_musicfestivals_wng_syllabusResultsProcess($ciniki, $tnid, $request, $section);
    ...
    } elseif( $section['ref'] == 'ciniki.musicfestivals.scheduleoverview' ) {
        ciniki_core_loadMethod($ciniki, 'ciniki', 'musicfestivals', 'wng', 'scheduleOverviewProcess');
        return ciniki_musicfestivals_wng_scheduleOverviewProcess($ciniki, $tnid, $request, $section);
    } elseif( $section['ref'] == 'ciniki.musicfestivals.scheduleoverviewdays' ) {
        ciniki_core_loadMethod($ciniki, 'ciniki', 'musicfestivals', 'wng', 'scheduleOverviewDaysProcess');
        return ciniki_musicfestivals_wng_scheduleOverviewDaysProcess($ciniki, $tnid, $request, $section);
        ...
        ciniki_core_loadMethod($ciniki, 'ciniki', 'musicfestivals', 'wng', 'schedulesProcess');
        return ciniki_musicfestivals_wng_schedulesProcess($ciniki, $tnid, $request, $section);
    } elseif( $section['ref'] == 'ciniki.musicfestivals.provincialresults' ) {
        ciniki_core_loadMethod($ciniki, 'ciniki', 'musicfestivals', 'wng', 'provincialResultsProcess');
        return ciniki_musicfestivals_wng_provincialResultsProcess($ciniki, $tnid, $request, $section);
        ...
        ciniki_core_loadMethod($ciniki, 'ciniki', 'musicfestivals', 'wng', 'ssamchartProcess');
        return ciniki_musicfestivals_wng_ssamchartProcess($ciniki, $tnid, $request, $section);
    } elseif( $section['ref'] == 'ciniki.musicfestivals.artwork' ) {
        ciniki_core_loadMethod($ciniki, 'ciniki', 'musicfestivals', 'wng', 'artworkProcess');
        return ciniki_musicfestivals_wng_artworkProcess($ciniki, $tnid, $request, $section);
    ...
    } elseif( $section['ref'] == 'ciniki.musicfestivals.countdown' ) {
        ciniki_core_loadMethod($ciniki, 'ciniki', 'musicfestivals', 'wng', 'countdownProcess');
        return ciniki_musicfestivals_wng_countdownProcess($ciniki, $tnid, $request, $section);
