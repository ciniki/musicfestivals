...
// -------
//
function ciniki_musicfestivals_memberFieldSearch($ciniki) {
    //  
    ...
    $rc = ciniki_musicfestivals_checkAccess($ciniki, $args['tnid'], 'ciniki.musicfestivals.memberFieldSearch'); 
    if( $rc['stat'] != 'ok' ) { 
        return $rc;
    }   
    ...
    $strsql = "SELECT DISTINCT " . $args['field'] . " AS value "
        ...
        . "WHERE ciniki_musicfestivals_members.tnid = '" . ciniki_core_dbQuote($ciniki, $args['tnid']) . "' "
