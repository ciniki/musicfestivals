...
function ciniki_musicfestivals_fileDelete(&$ciniki) {
    ...
    $rc = ciniki_musicfestivals_checkAccess($ciniki, $args['business_id'], 'ciniki.musicfestivals.fileDelete', 0); 
    if( $rc['stat'] != 'ok' ) { 
        return $rc;
    }   
    ...
    return ciniki_core_objectDelete($ciniki, $args['business_id'], 'ciniki.musicfestivals.file', $args['file_id'], $uuid, 0x07);
}
?>
