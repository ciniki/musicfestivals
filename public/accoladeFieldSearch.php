...
// -------
//
function ciniki_musicfestivals_accoladeFieldSearch($ciniki) {
    //  
    ...
    $rc = ciniki_core_prepareArgs($ciniki, 'no', array(
        ...
        'field'=>array('required'=>'yes', 'blank'=>'no', 'validlist'=>array('typename', 'category'), 'name'=>'Field'),
    ...
    $rc = ciniki_musicfestivals_checkAccess($ciniki, $args['tnid'], 'ciniki.musicfestivals.accoladeFieldSearch'); 
    if( $rc['stat'] != 'ok' ) { 
        return $rc;
    }   
