...
// Description
// -----------
// This method will add a new schedule section for the business.
//
// Arguments
// ---------
// api_key:
// auth_token:
// business_id:        The ID of the business to add the Schedule Section to.
//
// Returns
// -------
//
function ciniki_musicfestivals_scheduleSectionAdd(&$ciniki) {
    ...
    $rc = ciniki_musicfestivals_checkAccess($ciniki, $args['business_id'], 'ciniki.musicfestivals.scheduleSectionAdd');
    if( $rc['stat'] != 'ok' ) {
        return $rc;
    }
    ...
    $rc = ciniki_core_objectAdd($ciniki, $args['business_id'], 'ciniki.musicfestivals.schedulesection', $args, 0x04);
    if( $rc['stat'] != 'ok' ) {
