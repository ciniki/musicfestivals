...
// Description
// -----------
// This method returns the list of value for a field in a table. This is used to get lists for categories, etc.
//
// Arguments
// ---------
// 
...
// -------
//
function ciniki_musicfestivals_fieldSearch($ciniki) {
    //  
    ...
    $rc = ciniki_core_prepareArgs($ciniki, 'no', array(
        ...
        'table'=>array('required'=>'yes', 'blank'=>'no', 'validlist'=>array('adjudicators'), 'name'=>'Table'),
    ...
    $rc = ciniki_musicfestivals_checkAccess($ciniki, $args['tnid'], 'ciniki.musicfestivals.fieldSearch'); 
    if( $rc['stat'] != 'ok' ) { 
        return $rc;
    }   
    ...
    $strsql = "SELECT DISTINCT {$args['field']} AS value "
        . "FROM ciniki_musicfestival_{$args['table']} "
