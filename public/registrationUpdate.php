...
function ciniki_musicfestivals_registrationUpdate(&$ciniki) {
    ...
    $rc = ciniki_core_prepareArgs($ciniki, 'no', array(
        ...
        'source1'=>array('required'=>'no', 'blank'=>'yes', 'name'=>'Source'),
        'source2'=>array('required'=>'no', 'blank'=>'yes', 'name'=>'Source'),
        'source3'=>array('required'=>'no', 'blank'=>'yes', 'name'=>'Source'),
        'source4'=>array('required'=>'no', 'blank'=>'yes', 'name'=>'Source'),
        'source5'=>array('required'=>'no', 'blank'=>'yes', 'name'=>'Source'),
        'source6'=>array('required'=>'no', 'blank'=>'yes', 'name'=>'Source'),
        'source7'=>array('required'=>'no', 'blank'=>'yes', 'name'=>'Source'),
        'source8'=>array('required'=>'no', 'blank'=>'yes', 'name'=>'Source'),
        ...
        'provincials_notes'=>array('required'=>'no', 'blank'=>'yes', 'name'=>'Provincials Notes'),
    ...
    if( isset($festival['scheduling-timeslot-startnum']) && $festival['scheduling-timeslot-startnum'] == 'yes' 
        ...
        if( $rc['stat'] != 'ok' ) {
            return array('stat'=>'fail', 'err'=>array('code'=>'ciniki.musicfestivals.966', 'msg'=>'Unable to load timeslot', 'err'=>$rc['err']));
        }
    ...
    if( isset($args['timeslot_id']) && $args['timeslot_id'] > 0 
        ...
        if( ciniki_core_checkModuleFlags($ciniki, 'ciniki.musicfestivals', 0x080000) ) {
            ...
            if( isset($args['timeslot_sequence']) 
                ...
                $rc = ciniki_core_dbHashQuery($ciniki, $strsql, 'ciniki.musicfestivals', 'timeslot');
                if( $rc['stat'] != 'ok' ) {
                    return array('stat'=>'fail', 'err'=>array('code'=>'ciniki.musicfestivals.967', 'msg'=>'Unable to load timeslot', 'err'=>$rc['err']));
                }
                if( !isset($rc['timeslot']) ) {
                ...
                $strsql = "SELECT registrations.timeslot_time, "
                    ...
                    . "IFNULL(classes.schedule_at_seconds, 0) AS schedule_at_seconds, "
                    . "IFNULL(classes.schedule_ata_seconds, 0) AS schedule_ata_seconds "
                    . "FROM ciniki_musicfestival_registrations AS registrations "
