...
function ciniki_musicfestivals_scheduleSectionDelete(&$ciniki) {
    ...
    $rc = ciniki_musicfestivals_checkAccess($ciniki, $args['tnid'], 'ciniki.musicfestivals.scheduleSectionDelete');
    if( $rc['stat'] != 'ok' ) {
        return $rc;
    }
    ...
    $rc = ciniki_core_objectCheckUsed($ciniki, $args['tnid'], 'ciniki.musicfestivals.scheduleSection', $args['schedulesection_id']);
    if( $rc['stat'] != 'ok' ) {
    ...
    //
    $rc = ciniki_core_objectDelete($ciniki, $args['tnid'], 'ciniki.musicfestivals.schedulesection',
