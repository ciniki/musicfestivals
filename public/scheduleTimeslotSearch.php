...
function ciniki_musicfestivals_scheduleTimeslotSearch($ciniki) {
    ...
    $rc = ciniki_musicfestivals_checkAccess($ciniki, $args['tnid'], 'ciniki.musicfestivals.scheduleTimeslotSearch');
    if( $rc['stat'] != 'ok' ) {
        return $rc;
    }
    ...
    $strsql = "SELECT ciniki_musicfestival_schedule_timeslots.id, "
        ...
        . "ciniki_musicfestival_schedule_timeslots.class4_id, "
        . "ciniki_musicfestival_schedule_timeslots.class5_id, "
