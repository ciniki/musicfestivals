...
// -------
//
function ciniki_musicfestivals_categoryFieldSearch($ciniki) {
    //  
    ...
    $rc = ciniki_core_prepareArgs($ciniki, 'no', array(
        ...
        'field'=>array('required'=>'yes', 'blank'=>'no', 'validlist'=>array('groupname'), 'name'=>'Field'),
    ...
    $rc = ciniki_musicfestivals_checkAccess($ciniki, $args['tnid'], 'ciniki.musicfestivals.categoryFieldSearch'); 
    if( $rc['stat'] != 'ok' ) { 
        return $rc;
    }   
