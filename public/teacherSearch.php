...
// -------
//
function ciniki_musicfestivals_teacherSearch($ciniki) {
    //
    ...
    $rc = ciniki_musicfestivals_checkAccess($ciniki, $args['tnid'], 'ciniki.musicfestivals.teacherSearch');
    if( $rc['stat'] != 'ok' ) {
        return $rc;
    }
    ...
    $rc = ciniki_core_dbHashQueryArrayTree($ciniki, $strsql, 'ciniki.musicfestivals', array(
        array('container'=>'teachers', 'fname'=>'id', 
    ...
    $teacher_ids = [];
    foreach($teachers as $aid => $teacher) {
        $teacher_ids[] = $teacher['id'];
    }

    return array('stat'=>'ok', 'teachers'=>$teachers, 'nplist'=>$teacher_ids);
}
?>
