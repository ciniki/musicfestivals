...
// Description
// -----------
// This method will return the list of actions that were applied to an element of an adjudicator recommendation entry.
...
// entry_id:          The ID of the adjudicator recommendation entry to get the history for.
// field:                   The field to get the history for.
//
// Returns
// -------
//
function ciniki_musicfestivals_recommendationEntryHistory($ciniki) {
    //
    ...
    $rc = ciniki_musicfestivals_checkAccess($ciniki, $args['tnid'], 'ciniki.musicfestivals.recommendationEntryHistory');
    if( $rc['stat'] != 'ok' ) {
        return $rc;
    }
