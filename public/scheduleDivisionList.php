...
// Description
// -----------
// This method will return the list of Schedule Divisions for a business.
//
// Arguments
// ---------
// api_key:
...
function ciniki_musicfestivals_scheduleDivisionList($ciniki) {
    ...
    $rc = ciniki_musicfestivals_checkAccess($ciniki, $args['business_id'], 'ciniki.musicfestivals.scheduleDivisionList');
    if( $rc['stat'] != 'ok' ) {
        return $rc;
    }
