...
// Description
// -----------
// This method will add a new trophy category for the tenant.
//
// Arguments
// ---------
// api_key:
// auth_token:
// tnid:        The ID of the tenant to add the Trophy Category to.
//
// Returns
// -------
//
function ciniki_musicfestivals_trophyCategoryAdd(&$ciniki) {
    //
    ...
    $rc = ciniki_musicfestivals_checkAccess($ciniki, $args['tnid'], 'ciniki.musicfestivals.trophyCategoryAdd');
    if( $rc['stat'] != 'ok' ) {
        return $rc;
    }
    ...
    if( $rc['num_rows'] > 0 ) {
        return array('stat'=>'fail', 'err'=>array('code'=>'ciniki.musicfestivals.1102', 'msg'=>'You already have a trophy category with that name, please choose another.'));
    }
    ...
    //
    // Add the trophy category to the database
    //
    ciniki_core_loadMethod($ciniki, 'ciniki', 'core', 'private', 'objectAdd');
    $rc = ciniki_core_objectAdd($ciniki, $args['tnid'], 'ciniki.musicfestivals.trophycategory', $args, 0x04);
    if( $rc['stat'] != 'ok' ) {
    ...
    $rc = ciniki_core_sequencesUpdate($ciniki, $args['tnid'], 'ciniki.musicfestivals.trophycategory', 
    ...
    ciniki_core_hookExec($ciniki, $args['tnid'], 'ciniki', 'web', 'indexObject', array('object'=>'ciniki.musicfestivals.trophyCategory', 'object_id'=>$category_id));
