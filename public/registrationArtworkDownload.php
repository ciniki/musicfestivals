...
// Description
// ===========
// This function will download a artwork for a registration
//
// Arguments
// ---------
// api_key:
...
// -------
//
function ciniki_musicfestivals_registrationArtworkDownload($ciniki) {
    //
    ...
    if( $rc['stat'] != 'ok' ) {
        return array('stat'=>'fail', 'err'=>array('code'=>'ciniki.musicfestivals.105', 'msg'=>'Unable to load registration', 'err'=>$rc['err']));
    }
    if( !isset($rc['registration']) ) {
        return array('stat'=>'fail', 'err'=>array('code'=>'ciniki.musicfestivals.187', 'msg'=>'Unable to find requested registration'));
    }
    ...
    $storage_filename = $rc['storage_dir'] . '/ciniki.musicfestivals/files/' 
        . $registration['uuid'][0] . '/' . $registration['uuid'] . '_artwork' . $args['num'];
    if( !file_exists($storage_filename) ) {
        return array('stat'=>'fail', 'err'=>array('code'=>'ciniki.musicfestivals.253', 'msg'=>'File does not exist'));
    }
    ...
    // Specify Filename
    header('Content-Disposition: attachment;filename="' . $registration["artwork{$args['num']}"] . '"');
