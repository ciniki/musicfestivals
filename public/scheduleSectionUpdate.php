...
function ciniki_musicfestivals_scheduleSectionUpdate(&$ciniki) {
    ...
    $rc = ciniki_core_prepareArgs($ciniki, 'no', array(
        ...
        'pdffooter_sponsors_title'=>array('required'=>'no', 'blank'=>'yes', 'name'=>'Bottom Sponsors Title'),
        'pdffooter_sponsor_ids'=>array('required'=>'no', 'blank'=>'yes', 'type'=>'idlist', 'name'=>'Footer Sponsors'),
