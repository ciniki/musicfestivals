...
// Description
// -----------
// This method searchs for a Competitors for a business.
//
// Arguments
// ---------
// api_key:
...
function ciniki_musicfestivals_competitorSearch($ciniki) {
    ...
    $rc = ciniki_musicfestivals_checkAccess($ciniki, $args['business_id'], 'ciniki.musicfestivals.competitorSearch');
    if( $rc['stat'] != 'ok' ) {
        return $rc;
    }
