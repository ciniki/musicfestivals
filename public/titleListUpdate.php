...
// -------
//
function ciniki_musicfestivals_titleListUpdate(&$ciniki) {
    //
    ...
    if( isset($args['name']) ) {
        ...
        if( $rc['num_rows'] > 0 ) {
            return array('stat'=>'fail', 'err'=>array('code'=>'ciniki.musicfestivals.1151', 'msg'=>'You already have an approved title list with this name, please choose another.'));
        }
    }
    ...
    //
    // Update the Approved Title List in the database
    //
    ciniki_core_loadMethod($ciniki, 'ciniki', 'core', 'private', 'objectUpdate');
    $rc = ciniki_core_objectUpdate($ciniki, $args['tnid'], 'ciniki.musicfestivals.titlelist', $args['list_id'], $args, 0x04);
    if( $rc['stat'] != 'ok' ) {
    ...
    ciniki_core_hookExec($ciniki, $args['tnid'], 'ciniki', 'web', 'indexObject', array('object'=>'ciniki.musicfestivals.titleList', 'object_id'=>$args['list_id']));
