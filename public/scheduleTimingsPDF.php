...
// -------
//
function ciniki_musicfestivals_scheduleTimingsPDF($ciniki) {
    //
    ...
    $rc = ciniki_core_prepareArgs($ciniki, 'no', array(
        ...
        'ssection_id'=>array('required'=>'yes', 'blank'=>'yes', 'name'=>'Schedule Section'),
    ...
    $rc = ciniki_musicfestivals_checkAccess($ciniki, $args['tnid'], 'ciniki.musicfestivals.scheduleTimingsPDF');
    if( $rc['stat'] != 'ok' ) {
        return $rc;
    }
