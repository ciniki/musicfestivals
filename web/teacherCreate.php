...
// -------
//
function ciniki_musicfestivals_web_teacherCreate(&$ciniki, $settings, $tnid, $args) {
    ...
    if( $rc['stat'] != 'ok' ) {
        return array('stat'=>'error', 'err'=>array('code'=>'ciniki.musicfestivals.146', 'msg'=>"We had a problem saving the theacher, please try again or contact us for help."));
    }
