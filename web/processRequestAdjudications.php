...
// -------
//
function ciniki_musicfestivals_web_processRequestAdjudications(&$ciniki, $settings, $tnid, $args) {
...
//        . "timeslots.name AS timeslot_name, "
    ...
    if( isset($args['uri_split'][1]) && isset($divisions[$args['uri_split'][0]]['timeslots'][$args['uri_split'][1]]) ) {
        ...
        if( isset($args['uri_split'][3]) && $args['uri_split'][3] == 'music' && isset($timeslot['registrations'][$args['uri_split'][2]]) ) {
            ...
            header('Content-Disposition: inline;filename="' . $registration['music_orgfilename'] . '"');
    ...
    if( $display == 'timeslot' ) {
        ...
        foreach($timeslot['registrations'] as $registration) {
            ...
            if( isset($_POST['action']) && $_POST['action'] == 'update' ) {
                ...
                if( count($update_args) > 0 ) {
                    if( $registration['comment_id'] > 0 ) {
                        ...
                        $rc = ciniki_core_objectUpdate($ciniki, $tnid, 'ciniki.musicfestivals.comment', $registration['comment_id'], $update_args, 0x04);
                        if( $rc['stat'] != 'ok' ) {
            ...
            $content .= '<div class="registration wide">'
                ...
                . '<b>Video: </b><a target="_blank" href="' . $registration['videolink'] . '">' . $registration['videolink'] . '</a><br/>'
                . '<b>Music: </b><a target="_blank" href="' . $base_url . '/' . $registration['uuid'] . '/music">' . $registration['music_orgfilename'] . '</a><br/>'
                . '';
